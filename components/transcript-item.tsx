...
function TranscriptItem({ item, searchInput }: TranscriptItemProps) {
  ...
  return (
    <div
      ...
      className="flex flex-col w-full justify-between items-center p-3 border-[0.5px] rounded-md border-zinc-200 space-y-4 group dark:bg-[#0F0F0F] dark:text-white">
